declare namespace ty {
  ...
  export function getCurrentWifiSSID(params?: {
    complete?: () => void
    success?: (params: { ssId: string }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
  ...
  export function getIconfontInfo(params?: {
    complete?: () => void
    success?: (params: { nameMap: string }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
  ...
  export function uploadImage(params: {
    ...
    pollMaxCount?: number
    complete?: () => void
    success?: (params: { result: string }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
  ...
  export function getLangKey(params?: {
    complete?: () => void
    success?: (params: { langKey: string }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
  ...
  export function getLangContent(params?: {
    complete?: () => void
    success?: (params: { langContent: {} }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
  ...
  export function canIUseRouter(params: {
    url: string
    complete?: () => void
    success?: (params: { result: boolean }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
  ...
  export function getShareChannelList(params?: {
    complete?: () => void
    success?: (params: { shareChannelList: string[] }) => void
    fail?: (params: {
      errorMsg: string
      errorCode: string | number
      innerError: {
