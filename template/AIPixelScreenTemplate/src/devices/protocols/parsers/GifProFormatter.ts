...
export default class GifProFormatter {
  uuid: string;
  defaultValue: {
    md5Id: string;
    programId?: number;
  ...
  constructor(uuid = 'gif_pro', defaultValue = null) {
    this.defaultValue = {
      programId: 60,
      md5Id: '',
      mode: 0,
