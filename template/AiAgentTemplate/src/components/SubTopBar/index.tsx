...
import { getDevInfo, navigateBack, View } from '@ray-js/ray';
...
export const TopBar: FC<TopBarProps> = ({
  ...
  return (
    <View
      className={clsx(styles.topbarWrap, { [styles.fixed]: fixed })}
      style={{
        backgroundColor,
        color: textColor,
        height: fixed ? `${statusBarHeight + 44}px` : 'unset',
      }}
    >
      <View className={clsx({ [styles.fixedContent]: fixed })}>
        ...
        <View className={styles.topbar}>
          ...
          <View className={styles.right} onClick={e => onRightClick?.(e)}>
            {right}
          </View>
        </View>
      </View>
