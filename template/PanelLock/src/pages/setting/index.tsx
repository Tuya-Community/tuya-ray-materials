...
const Index: FC = () => {
  ...
  return (
    <>
      <NavBar
        title={Strings.getLang('title_setting')}
        fixed
        placeholder
        leftArrow
          ...
          {settingsSchema.map(item => {
            ...
            switch (dpType) {
                ...
                content = (
                  <View className={styles.valueView}>
                    <Text className={styles.text}>
                      {Strings.getDpLang(item.code, dpState[item.code as any])}
                    </Text>
              ...
              case 'value':
                content = (
                  <View className={styles.valueView}>
                    <Text className={styles.text}>{`${utils.scaleNumber(
                      dpScale,
                      dpState[item.code]
                    )}${dpUnit}`}</Text>
                    <Icon type="icon-right" size={24} color="rgba(0,0,0,0.2)" />
