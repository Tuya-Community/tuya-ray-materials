  ...
  return (
    <View className={styles.container}>
      <View className={styles.header}>
        <Text style={{ margin: '32rpx 0', fontSize: '32rpx' }}>
          {Strings.getLang('Password_cleanType_HeaderTitle')}
        </Text>
        {clearAll ? (
          <Text style={{ color: '#999', fontSize: '24rpx' }}>
            {Strings.getLang('Password_cleanType_allTip')}
          </Text>
        ) : (
          <>
            <Text style={{ color: '#999', fontSize: '24rpx' }}>
              {Strings.getLang('Password_cleanType_select')}
            </Text>
