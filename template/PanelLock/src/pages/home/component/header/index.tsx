...
import { DefendTime } from '@/components';
...
const HomeTopView: React.FC = () => {
  ...
  return (
    <View>
      <DefendTime fontText={Strings.getLang('safeTipA')} backText={Strings.getLang('safeTipB')} />
      {isShowEle && (
