  ...
  return (
    ...
    >
      <View className={styles.circle}>
        <Image src={logoUrl === '' ? imgAILogo : logoUrl} className={styles.logo} />
      </View>
      <View className={styles.textBox}>
        <View>
          ...
          {creator && (
            <Text className={styles.aiCreator} style={circleColor && { color: circleColor }}>
              {creator}
            </Text>
          )}
        </View>
