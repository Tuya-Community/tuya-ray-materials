...
const CloneSetting: FC = () => {
  ...
  const goToClone = () => {
    router.push(`/cloneVoice?cloneWay=${cloneWay}&remainTimes=${remainTimes}`);
  };
    ...
    <View className={styles.view}>
      ...
      <View className={styles.topContent}>
        ...
        <TouchableOpacity
          ...
          style={{
            border: cloneWay === 'reciting' ? '6rpx solid #408CFF' : '6rpx solid transparent',
          }}
        ...
        <TouchableOpacity
          className={styles.singleWay}
          style={{
            border: cloneWay === 'record' ? '6rpx solid #408CFF' : '6rpx solid transparent',
          }}
