...
export const devices = {
  ...
  common: isGroupDevice
    ? new SmartGroupModel<
        SmartDeviceSchema,
        {
          support: SmartSupportAbility<SmartDeviceSchema>;
          storage: SmartStorageAbility;
        }
      >()
    : new SmartDeviceModel<
        SmartDeviceSchema,
        {
          support: SmartSupportAbility<SmartDeviceSchema>;
          storage: SmartStorageAbility;
...
export const getSupport = () => devices.common.model.abilities.support;
export const getDevInfo = () => devices.common.getDevInfo();
