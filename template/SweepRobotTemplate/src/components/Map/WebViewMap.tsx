...
const WebViewMap: React.FC<Props> = React.memo(
  props => {
    ...
    const detectedObjectsFromStore = useSelector(selectMapStateByKey('detectedObjects'));
    ...
    const {
      ...
      detectedObjects = detectedObjectsFromStore,
      config = MAP_CONFIG,
      onMapFirstDrawed,
      onMapDrawed,
      ...restProps
