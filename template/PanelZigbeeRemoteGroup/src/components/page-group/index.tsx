...
import { DialogSelectIcon, ColorImage, FixedBottom } from '@/components';
...
const TopBarContentHeight = 44;
const TopBarHeight = TopBarContentHeight + statusBarHeight;
...
export const PageGroup: React.FC<Props> = props => {
  ...
  return (
    <View className={styles.view} style={{ background: props.background }}>
      <NavBar
        customStyle={{ position: 'fixed', left: 0, top: 0 }}
        title={props.title}
