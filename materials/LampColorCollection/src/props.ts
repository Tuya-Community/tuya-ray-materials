...
export interface IProps {
  ...
  /**
   * @description.zh 整体样式，V1.2.0开始支持
   * @description.en The overall style，Supported starting from V1.2.0 or above
   * @default {}
   */
  style?: React.CSSProperties;

  /**
   * @description.zh 整体类名，V1.2.0开始支持
   * @description.en The overall class name, Supported starting from V1.2.0 or above
   * @default ''
   */
  className?: string;
  ...
  /**
   * @description.zh 删除 icon 样式
   * @description.en Delete icon style
   * @default {}
   */
  ...
  /**
   * @description.zh 内容类名， V1.2.0开始支持
   * @description.en Content class name，Supported starting from V1.2.0 or above
   * @default ''
   */
  contentClassName?: string;

  /**
   * @description.zh 圆形大小, 单位: px，V1.2.0开始支持
   * @description.en Circle size, unit: px，Supported starting from V1.2.0 or above
   * @default 48
   */
  circleSize?: number;
  /**
